...
func TestProxy(t *testing.T) {
	...
	// server listens for "ping" messages and replies with a "pong"
	// message. All other messages are echoed back to the client.
	...
	// Replies from the destination server are also proxied back to the clients.
